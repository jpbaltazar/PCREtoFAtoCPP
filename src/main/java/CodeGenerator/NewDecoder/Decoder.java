package CodeGenerator.NewDecoder;
...
public class Decoder {
    ...
    ArrayList<ArrayList<String>> cataloguedConditions = new ArrayList<>();
    ...
    public Decoder(FAGraph graph, CodeGeneratorOptions options, int ruleID){
        ...
        for (Edge e : graph.edgeSet()){
            if(!e.isBackreference){
                ...
                if(!cataloguedConditions.contains(e.conditions)){
                    cataloguedConditions.add(e.conditions);
                }
            }
        }
        ...
        for (i = 0; i < cataloguedConditions.size(); i++){
            ...
            for (String condition : cataloguedConditions.get(i)){
        ...
        decoderComplexity = 0;
        for (ArrayList<String> condition : cataloguedConditions){
            for (String individualGroup : condition){
